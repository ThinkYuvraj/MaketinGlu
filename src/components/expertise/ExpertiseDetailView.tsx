        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 2xl:gap-20 items-center">
            ...
            <div className="lg:col-span-7 xl:col-span-7 2xl:col-span-7 space-y-6 sm:space-y-7">
              ...
              {/* Action Buttons: Request Consultation & WhatsApp */}
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                ...
                <motion.a
                  {...buttonHoverMotion}
                  href={`https://wa.me/+919654596149?text=${encodeURIComponent(`Hi Marketing LU, I would like to inquire about your ${activeExpertise.title} services.`)}`}
                  target="_blank"
